...
- 风险仓位：每笔风险2%本金，止损1.5×ATR，止盈6×ATR
...
| 梯队 | 夏普比>1.0 | 品种 |
|------|-----------|------|
| 第一梯队 | >5.0 | JM、P、CS、BU、V |
| 第二梯队 | 2.0~5.0 | TA、I、A、AL、ZN |
| 第三梯队 | 1.0~2.0 | PP、SC、RU、M、CF、RB、SR、MA |
...
| 品种 | 收益率 | 交易 | 胜率 | 净利润 |
|------|---------|------|------|---------|
| PTA(TA) | +8.23% | 23笔 | 47.8% | +8,230 |
| 橡胶(RU) | +3.99% | 5笔 | 60.0% | +3,990 |
| 棕榈油(P) | +3.68% | 20笔 | 70.0% | +3,680 |
| 甲醇(MA) | +2.37% | 22笔 | 50.0% | +2,370 |
| 沥青(BU) | +1.44% | 26笔 | 46.2% | +1,440 |
| 黄大豆A(A) | +1.14% | 22笔 | 54.5% | +1,140 |
| 聚丙烯(PP) | +1.08% | 26笔 | 42.3% | +1,080 |
| 螺纹钢(RB) | +0.33% | 2笔 | 100% | +330 |
| 焦煤(JM) | +0.36% | 2笔 | 50.0% | +360 |
| 铝(AL) | -0.20% | 2笔 | 50.0% | -200 |
| 白糖(SR) | -0.46% | 3笔 | 33.3% | -460 |
| 棉花(CF) | -1.88% | 16笔 | 43.8% | -1,880 |
| 锌(ZN) | -2.73% | 13笔 | 23.1% | -2,730 |
| PVC(V) | -3.68% | 4笔 | 25.0% | -3,680 |

> 注：33品种回测为波段模式，结果受2025年橡胶熊市拖累

---

### 2025年 白名单（18品种）多品种组合回测
...
> 结论：2025年组合负收益，主要被BU(-2,502)、ZN(-2,574)、V(-1,432)拖累
